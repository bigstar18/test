...
public class DoRegex {
	...
	private static final String rootUrlRegex = "(http://.*?/)";
	private static final String currentUrlRegex = "(http://.*/)";
	 ...
	 */
	public static List<String> getArrayList(String dealStr, String regexStr, int n, String currentUrl) {
		List<String> reArrayList = new ArrayList<String>();
		if (dealStr == null || regexStr == null || n < 1 || dealStr.isEmpty()) {
			return reArrayList;
		}
